...
export declare type SliderSlot = 'root' | 'mark' | 'markLabel' | 'rail' | 'track' | 'thumb' | 'valueLabel' | 'input';
...
export interface SliderOwnProps {
    ...
    componentsProps?: {
        ...
        rail?: SlotComponentProps<'span', {
            sx?: SxProps;
        }, SliderOwnerState>;
        thumb?: SlotComponentProps<'span', {
            sx?: SxProps;
        }, SliderOwnerState>;
        mark?: SlotComponentProps<'span', {
            sx?: SxProps;
        }, SliderOwnerState>;
        markLabel?: SlotComponentProps<'span', {
            sx?: SxProps;
        }, SliderOwnerState>;
        valueLabel?: SlotComponentProps<'span', {
            sx?: SxProps;
        }, SliderOwnerState>;
