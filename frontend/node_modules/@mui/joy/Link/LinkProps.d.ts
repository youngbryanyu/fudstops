...
import { ColorPaletteProp, TypographySystem, VariantProp, SxProps, SystemProps } from '../styles/types';
export declare type LinkSlot = 'root' | 'startDecorator' | 'endDecorator';
...
export declare type LinkProps<D extends React.ElementType = LinkTypeMap['defaultComponent'], P = {
