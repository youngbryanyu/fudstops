...
export declare type ButtonSlot = 'root' | 'startDecorator' | 'endDecorator';
...
interface ComponentsProps {
    root?: SlotComponentProps<'button', {
        sx?: SxProps;
    }, ButtonOwnerState>;
    ...
    loadingIndicatorCenter?: SlotComponentProps<'span', {
        sx?: SxProps;
    }, ButtonOwnerState>;
}
...
export declare type ButtonProps<D extends React.ElementType = ButtonTypeMap['defaultComponent'], P = {
...
export declare type ExtendButton<M extends OverridableTypeMap> = ((props: OverrideProps<ExtendButtonTypeMap<M>, 'a'>) => JSX.Element) & OverridableComponent<ExtendButtonTypeMap<M>>;
export {};
