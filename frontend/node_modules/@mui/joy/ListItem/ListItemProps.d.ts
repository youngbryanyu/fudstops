...
export declare type ListItemSlot = 'root' | 'startAction' | 'endAction';
...
export declare type ListItemProps<D extends React.ElementType = ListItemTypeMap['defaultComponent'], P = {
