...
export declare type AspectRatioSlot = 'root' | 'content';
...
export declare type AspectRatioProps<D extends React.ElementType = AspectRatioTypeMap['defaultComponent'], P = {
