...
export declare type AlertSlot = 'root' | 'startDecorator' | 'endDecorator';
...
export declare type AlertProps<D extends React.ElementType = AlertTypeMap['defaultComponent'], P = {
