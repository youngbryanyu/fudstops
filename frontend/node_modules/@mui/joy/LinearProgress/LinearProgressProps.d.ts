...
export declare type LinearProgressSlot = 'root';
...
export declare type LinearProgressProps<D extends React.ElementType = LinearProgressTypeMap['defaultComponent'], P = {
