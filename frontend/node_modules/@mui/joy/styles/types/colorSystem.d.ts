...
export declare type ExtendedPaletteRange = OverridableStringUnion<'50' | '100' | '200' | '300' | '400' | '500' | '600' | '700' | '800' | '900' | 'mainChannel' | 'lightChannel' | 'darkChannel', PaletteRangeOverrides>;
...
export declare type DefaultColorPalette = 'primary' | 'neutral' | 'danger' | 'info' | 'success' | 'warning';
export declare type ColorPaletteProp = OverridableStringUnion<DefaultColorPalette, ColorPalettePropOverrides>;
...
export declare type ApplyColorInversion<T extends {
