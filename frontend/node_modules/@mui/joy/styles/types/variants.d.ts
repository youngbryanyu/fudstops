...
export declare type DefaultVariantProp = 'plain' | 'outlined' | 'soft' | 'solid';
export declare type VariantProp = OverridableStringUnion<DefaultVariantProp, VariantPropOverrides>;
declare type State = 'Hover' | 'Active' | 'Disabled';
export declare type VariantKey = DefaultVariantProp | `${DefaultVariantProp}${State}`;
export declare type DefaultVariantKey = Exclude<DefaultVariantProp, 'solid'> | `${Exclude<DefaultVariantProp, 'solid'>}${State}`;
