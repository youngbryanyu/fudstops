 ...
 * }
 */
export declare const createVariantStyle: (name: string, palette: Partial<PaletteRange> | undefined, getCssVar?: ((variantVar: keyof PaletteVariant) => string) | undefined) => CSSObject;
...
export declare const createSoftInversion: (theme: ThemeFragment & {
    getColorSchemeSelector: (colorScheme: DefaultColorScheme | ExtendedColorScheme) => string;
}) => Record<DefaultColorPalette, CSSObject>;
export declare const createSolidInversion: (theme: ThemeFragment) => Record<DefaultColorPalette, CSSObject>;
export {};
