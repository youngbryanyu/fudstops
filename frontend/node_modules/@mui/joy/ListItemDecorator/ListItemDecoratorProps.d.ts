...
export declare type ListItemDecoratorSlot = 'root';
...
export declare type ListItemDecoratorProps<D extends React.ElementType = ListItemDecoratorTypeMap['defaultComponent'], P = {
