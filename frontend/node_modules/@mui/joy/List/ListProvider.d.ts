...
export declare const scopedVariables: {
    ...
    '--List-itemButton-marginBlock': string;
    '--List-itemButton-marginInline': string;
    '--List-item-marginBlock': string;
    '--List-item-marginInline': string;
};
...
declare function ListProvider({ children, nested, row, wrap, }: React.PropsWithChildren<ListProviderProps>): JSX.Element;
