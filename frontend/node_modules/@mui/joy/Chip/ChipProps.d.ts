...
export declare type ChipSlot = 'root' | 'label' | 'action' | 'startDecorator' | 'endDecorator';
...
interface ComponentsProps {
    ...
    label?: SlotComponentProps<'span', {
        sx?: SxProps;
    }, ChipOwnerState>;
    action?: SlotComponentProps<'button', {
        sx?: SxProps;
...
export declare type ChipProps<D extends React.ElementType = ChipTypeMap['defaultComponent'], P = {
    component?: React.ElementType;
