...
export const ListItemButtonRoot = styled('div', {
  ...
  '--List-decorator-color': theme.vars.palette[ownerState.color]?.[`${ownerState.variant}DisabledColor`]
}, {
  ...
  [`&.${listItemButtonClasses.disabled}`]: theme.variants[`${ownerState.variant}Disabled`]?.[ownerState.color]
}]);
