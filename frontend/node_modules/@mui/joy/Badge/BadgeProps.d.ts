...
export declare type BadgeSlot = 'root' | 'badge';
...
export declare type BadgeProps<D extends React.ElementType = BadgeTypeMap['defaultComponent'], P = {
