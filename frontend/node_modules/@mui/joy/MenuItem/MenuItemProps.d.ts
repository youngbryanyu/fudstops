...
export declare type MenuItemSlot = 'root';
...
export declare type MenuItemProps<D extends React.ElementType = MenuItemTypeMap['defaultComponent'], P = {
...
export declare type ExtendMenuItem<M extends OverridableTypeMap> = ((props: OverrideProps<ExtendMenuItemTypeMap<M>, 'a'>) => JSX.Element) & OverridableComponent<ExtendMenuItemTypeMap<M>>;
