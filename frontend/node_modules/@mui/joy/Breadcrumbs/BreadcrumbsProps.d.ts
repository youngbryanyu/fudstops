...
export declare type BreadcrumbsSlot = 'root' | 'ol' | 'li' | 'separator';
export interface BreadcrumbsPropsSizeOverrides {
}
interface ComponentsProps {
    root?: SlotComponentProps<'nav', {
        sx?: SxProps;
    }, BreadcrumbsOwnerState>;
    ol?: SlotComponentProps<'ol', {
        sx?: SxProps;
    }, BreadcrumbsOwnerState>;
    li?: SlotComponentProps<'li', {
        sx?: SxProps;
    }, BreadcrumbsOwnerState>;
    separator?: SlotComponentProps<'li', {
        sx?: SxProps;
    }, BreadcrumbsOwnerState>;
}
...
export declare type BreadcrumbsProps<D extends React.ElementType = BreadcrumbsTypeMap['defaultComponent'], P = {
