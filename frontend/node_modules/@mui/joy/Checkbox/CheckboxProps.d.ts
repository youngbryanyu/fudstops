...
export declare type CheckboxSlot = 'root' | 'checkbox' | 'action' | 'input' | 'label';
...
interface ComponentsProps {
    ...
    checkbox?: SlotComponentProps<'span', {
        sx?: SxProps;
    }, CheckboxOwnerState>;
...
export declare type CheckboxProps<D extends React.ElementType = CheckboxTypeMap['defaultComponent'], P = {
