...
export declare type IconButtonSlot = 'root';
...
export declare type IconButtonProps<D extends React.ElementType = IconButtonTypeMap['defaultComponent'], P = {
...
export declare type ExtendIconButton<M extends OverridableTypeMap> = ((props: OverrideProps<ExtendIconButtonTypeMap<M>, 'a'>) => JSX.Element) & OverridableComponent<ExtendIconButtonTypeMap<M>>;
