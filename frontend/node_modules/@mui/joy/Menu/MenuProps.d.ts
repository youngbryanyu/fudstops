...
export declare type MenuSlot = 'root';
...
export declare type MenuProps<D extends React.ElementType = MenuTypeMap['defaultComponent'], P = {}> = OverrideProps<MenuTypeMap<P, D>, D>;
