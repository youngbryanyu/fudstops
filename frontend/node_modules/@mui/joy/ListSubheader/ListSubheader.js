...
const ListSubheaderRoot = styled('div', {
  ...
  var _theme$variants, _theme$vars$palette;
  ...
  return _extends({
    ...
    color: (_theme$vars$palette = theme.vars.palette[ownerState.color]) == null ? void 0 : _theme$vars$palette[500] // make the subheader less contrast
