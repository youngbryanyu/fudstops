...
import { ColorPaletteProp, TypographySystem, SxProps, SystemProps, VariantProp } from '../styles/types';
export declare type TypographySlot = 'root' | 'startDecorator' | 'endDecorator';
export interface TypographyPropsColorOverrides {
}
export interface TypographyPropsVariantOverrides {
}
interface ComponentsProps {
    root?: SlotComponentProps<'a', {
        sx?: SxProps;
...
export interface TypographyTypeMap<P = {}, D extends React.ElementType = 'span'> {
    props: P & Omit<SystemProps, 'color'> & {
        /**
...
export declare type TypographyProps<D extends React.ElementType = TypographyTypeMap['defaultComponent'], P = {
