...
export declare type RadioSlot = 'root' | 'radio' | 'icon' | 'action' | 'input' | 'label';
...
interface ComponentsProps {
    root?: SlotComponentProps<'span', {
        sx?: SxProps;
    }, RadioOwnerState>;
    radio?: SlotComponentProps<'span', {
        sx?: SxProps;
    }, RadioOwnerState>;
    icon?: SlotComponentProps<'span', {
        sx?: SxProps;
    }, RadioOwnerState>;
    action?: SlotComponentProps<'span', {
        sx?: SxProps;
    }, RadioOwnerState>;
    input?: SlotComponentProps<'input', {
        sx?: SxProps;
    }, RadioOwnerState>;
    label?: SlotComponentProps<'label', {
        sx?: SxProps;
    }, RadioOwnerState>;
}
export interface RadioTypeMap<P = {}, D extends React.ElementType = 'span'> {
    props: P & UseSwitchParameters & {
        /**
...
export declare type RadioProps<D extends React.ElementType = RadioTypeMap['defaultComponent'], P = {
    component?: React.ElementType;
