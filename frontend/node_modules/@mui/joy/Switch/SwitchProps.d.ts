...
export declare type SwitchSlot = 'root' | 'action' | 'input' | 'track' | 'thumb';
...
interface ComponentsProps {
    ...
    input?: SlotComponentProps<'button', {
        sx?: SxProps;
    }, SwitchOwnerState>;
...
export declare type SwitchProps<D extends React.ElementType = SwitchTypeMap['defaultComponent'], P = {
