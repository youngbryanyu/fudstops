...
export declare type RootProps = Omit<PopperUnstyledProps, 'direction'> & {
    /**
     * The system prop that allows defining system overrides as well as additional CSS styles.
     */
    sx?: SxProps;
};
export declare type TooltipSlot = 'root' | 'arrow';
...
export declare type TooltipProps<D extends React.ElementType = TooltipTypeMap['defaultComponent'], P = {
