...
export declare type TabsSlot = 'root';
...
export interface TabsTypeMap<P = {}, D extends React.ElementType = 'div'> {
    props: P & Omit<TabsUnstyledOwnProps, 'components' | 'componentsProps'> & {
        /**
...
export declare type TabsProps<D extends React.ElementType = TabsTypeMap['defaultComponent'], P = {
