...
export declare type OptionSlot = 'root';
...
export declare type OptionProps<D extends React.ElementType = OptionTypeMap['defaultComponent'], P = {
    component?: React.ElementType;
}> = OverrideProps<OptionTypeMap<P, D>, D>;
export interface OptionOwnerState extends Omit<OptionProps, 'disabled'>, OptionState {
}
export declare type ExtendOption<M extends OverridableTypeMap> = ((props: OverrideProps<ExtendOptionTypeMap<M>, 'a'>) => JSX.Element) & OverridableComponent<ExtendOptionTypeMap<M>>;
