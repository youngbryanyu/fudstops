...
export declare type ModalDialogClassKey = keyof ModalDialogClasses;
export declare function getModalDialogUtilityClass(slot: string): string;
declare const modalDialogClasses: ModalDialogClasses;
