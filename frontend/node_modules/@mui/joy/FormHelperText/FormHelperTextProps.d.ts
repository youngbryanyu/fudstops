...
export declare type FormHelperTextSlot = 'root';
...
export declare type FormHelperTextProps<D extends React.ElementType = FormHelperTextTypeMap['defaultComponent'], P = {
