...
export declare type TabListClassKey = keyof TabListClasses;
export declare function getTabListUtilityClass(slot: string): string;
declare const tabListClasses: TabListClasses;
