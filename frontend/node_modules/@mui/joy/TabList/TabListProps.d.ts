...
export declare type TabListSlot = 'root';
...
export declare type TabListProps<D extends React.ElementType = TabListTypeMap['defaultComponent'], P = {
    component?: React.ElementType;
}> = OverrideProps<TabListTypeMap<P, D>, D>;
export declare type TabListOwnerState = TabListProps & {
    /**
