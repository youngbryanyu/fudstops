...
export declare type TextFieldSlot = 'root';
declare type InputRootKeys = 'autoComplete' | 'autoFocus' | 'disabled' | 'error' | 'required' | 'fullWidth' | 'placeholder' | 'defaultValue' | 'value' | 'onChange' | 'onFocus' | 'onBlur' | 'type' | 'variant' | 'color' | 'size' | 'startDecorator' | 'endDecorator' | 'sx';
export interface TextFieldTypeMap<P = {}, D extends React.ElementType = 'div'> {
    props: P & Pick<InputProps, InputRootKeys> & {
        components?: {
...
export declare type TextFieldProps<D extends React.ElementType = TextFieldTypeMap['defaultComponent'], P = {
