...
export declare type ScopedCssBaselineSlot = 'root';
...
export declare type ScopedCssBaselineProps<D extends React.ElementType = ScopedCssBaselineTypeMap['defaultComponent'], P = {
