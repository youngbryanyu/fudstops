...
export declare type FormLabelSlot = 'root' | 'asterisk';
interface ComponentsProps {
    root?: SlotComponentProps<'label', {
        sx?: SxProps;
    }, FormLabelOwnerState>;
    asterisk?: SlotComponentProps<'span', {
        sx?: SxProps;
    }, FormLabelOwnerState>;
}
...
export declare type FormLabelProps<D extends React.ElementType = FormLabelTypeMap['defaultComponent'], P = {
