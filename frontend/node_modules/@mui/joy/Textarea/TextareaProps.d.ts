...
export declare type TextareaSlot = 'root' | 'textarea' | 'startDecorator' | 'endDecorator';
...
interface ComponentsProps {
    ...
    textarea?: SlotComponentProps<'textarea', {
        sx?: SxProps;
    }, TextareaOwnerState>;
...
export interface TextareaTypeMap<P = {}, D extends React.ElementType = 'div'> {
    props: P & Pick<React.TextareaHTMLAttributes<HTMLTextAreaElement>, 'autoComplete' | 'autoFocus' | 'onClick' | 'onChange' | 'onKeyDown' | 'onKeyUp' | 'onFocus' | 'onBlur' | 'defaultValue' | 'value' | 'placeholder' | 'readOnly' | 'required' | 'name' | 'id' | 'disabled'> & {
        /**
...
export declare type TextareaProps<D extends React.ElementType = TextareaTypeMap['defaultComponent'], P = {
