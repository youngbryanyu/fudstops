...
export declare type ListItemButtonSlot = 'root';
...
export declare type ListItemButtonProps<D extends React.ElementType = ListItemButtonTypeMap['defaultComponent'], P = {
...
export declare type ExtendListItemButton<M extends OverridableTypeMap> = ((props: OverrideProps<ExtendListItemButtonTypeMap<M>, 'a'>) => JSX.Element) & OverridableComponent<ExtendListItemButtonTypeMap<M>>;
