...
exports.default = exports.ListRoot = void 0;
...
const _excluded = ["component", "className", "children", "size", "row", "wrap", "variant", "color", "role"];
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', variant && `variant${(0, _utils.unstable_capitalize)(variant)}`, color && `color${(0, _utils.unstable_capitalize)(color)}`, !instanceSize && !nesting && size && `size${(0, _utils.unstable_capitalize)(size)}`, instanceSize && `size${(0, _utils.unstable_capitalize)(instanceSize)}`, nesting && 'nesting', row && 'row']
  };
  return (0, _composeClasses.default)(slots, _listClasses.getListUtilityClass, {});
};

const ListRoot = (0, _styles.styled)('ul', {
  name: 'JoyList',
  slot: 'Root',
  ...
  return [ownerState.nesting && (0, _extends2.default)({}, applySizeVars(ownerState.instanceSize), {
    ...
    margin: 'initial'
  }, ownerState.row ? (0, _extends2.default)({}, ownerState.wrap ? {
