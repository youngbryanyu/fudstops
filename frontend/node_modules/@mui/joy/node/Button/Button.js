...
const _excluded = ["children", "action", "component", "componentsProps", "color", "variant", "size", "fullWidth", "startDecorator", "endDecorator", "loading", "loadingPosition", "loadingIndicator", "disabled"];
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', disabled && 'disabled', focusVisible && 'focusVisible', fullWidth && 'fullWidth', variant && `variant${(0, _utils2.unstable_capitalize)(variant)}`, color && `color${(0, _utils2.unstable_capitalize)(color)}`, size && `size${(0, _utils2.unstable_capitalize)(size)}`, loading && 'loading'],
...
const ButtonRoot = (0, _styles.styled)('button', {
  ...
  return [(0, _extends2.default)({
    ...
    [`&.${_buttonClasses.default.disabled}`]: (_theme$variants8 = theme.variants[`${ownerState.variant}Disabled`]) == null ? void 0 : _theme$variants8[ownerState.color]
...
const Button = /*#__PURE__*/React.forwardRef(function Button(inProps, ref) {
  ...
  const handleRef = (0, _utils2.unstable_useForkRef)(buttonRef, ref);
  const {
    focusVisible,
    setFocusVisible,
    getRootProps
  ...
  const loadingIndicatorCenterProps = (0, _utils.useSlotProps)({
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(ButtonRoot, (0, _extends2.default)({}, rootProps, {
    children: [(startDecorator || loading && loadingPosition === 'start') && /*#__PURE__*/(0, _jsxRuntime.jsx)(ButtonStartDecorator, (0, _extends2.default)({}, startDecoratorProps, {
      children: loading && loadingPosition === 'start' ? loadingIndicator : startDecorator
    })), children, loading && loadingPosition === 'center' && /*#__PURE__*/(0, _jsxRuntime.jsx)(ButtonLoadingCenter, (0, _extends2.default)({}, loadingIndicatorCenterProps, {
      children: loadingIndicator
    })), (endDecorator || loading && loadingPosition === 'end') && /*#__PURE__*/(0, _jsxRuntime.jsx)(ButtonEndDecorator, (0, _extends2.default)({}, endDecoratorProps, {
