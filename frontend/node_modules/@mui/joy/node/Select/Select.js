...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    ...
    listbox: ['listbox', open && 'expanded', disabled && 'disabled', variant && `variant${(0, _utils.unstable_capitalize)(variant)}`, color && `color${(0, _utils.unstable_capitalize)(color)}`, size && `size${(0, _utils.unstable_capitalize)(size)}`]
  };
...
const SelectListbox = (0, _styles.styled)(_List.ListRoot, {
  name: 'JoySelect',
  slot: 'Listbox',
...
const Select = /*#__PURE__*/React.forwardRef(function Select(inProps, ref) {
  ...
  const _useSlotProps = (0, _utils2.useSlotProps)({
    ...
    component: listboxComponent
        ...
        listboxProps = (0, _objectWithoutPropertiesLoose2.default)(_useSlotProps, _excluded2);
  ...
  const indicatorProps = (0, _utils2.useSlotProps)({
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(React.Fragment, {
    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(SelectRoot, (0, _extends2.default)({}, rootProps, {
      children: [startDecorator && /*#__PURE__*/(0, _jsxRuntime.jsx)(SelectStartDecorator, (0, _extends2.default)({}, startDecoratorProps, {
        children: startDecorator
      })), /*#__PURE__*/(0, _jsxRuntime.jsx)(SelectButton, (0, _extends2.default)({}, buttonProps, {
        children: selectedOption ? renderValue(selectedOption) : placeholder
      })), endDecorator && /*#__PURE__*/(0, _jsxRuntime.jsx)(SelectEndDecorator, (0, _extends2.default)({}, endDecoratorProps, {
        children: endDecorator
      })), indicator && /*#__PURE__*/(0, _jsxRuntime.jsx)(SelectIndicator, (0, _extends2.default)({}, indicatorProps, {
        children: indicator
      }))]
    })), anchorEl &&
    /*#__PURE__*/
    // @ts-ignore internal logic: `listboxComponent` should not replace `SelectListbox`.
    (0, _jsxRuntime.jsx)(_PopperUnstyled.default, (0, _extends2.default)({}, listboxProps, {
      as: listboxComponent,
