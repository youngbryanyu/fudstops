...
const _excluded = ["propsToForward", "rootStateClasses", "inputStateClasses", "getRootProps", "getInputProps", "component", "componentsProps", "formControl", "focused", "error", "disabled", "fullWidth", "size", "color", "variant", "startDecorator", "endDecorator"];
...
const useUtilityClasses = ownerState => {
  ...
  return (0, _composeClasses.default)(slots, _inputClasses.getInputUtilityClass, {});
};

const InputRoot = (0, _styles.styled)('div', {
  name: 'JoyInput',
  slot: 'Root',
  ...
  return [(0, _extends2.default)({
    ...
    [`&:hover:not(.${_inputClasses.default.focused})`]: (0, _extends2.default)({}, (_theme$variants2 = theme.variants[`${ownerState.variant}Hover`]) == null ? void 0 : _theme$variants2[ownerState.color], {
...
const InputInput = (0, _styles.styled)('input', {
  name: 'JoyInput',
  slot: 'Input',
...
const InputStartDecorator = (0, _styles.styled)('span', {
  name: 'JoyInput',
  slot: 'StartDecorator',
...
const InputEndDecorator = (0, _styles.styled)('span', {
  name: 'JoyInput',
  slot: 'EndDecorator',
...
const Input = /*#__PURE__*/React.forwardRef(function Input(inProps, ref) {
  ...
  const startDecoratorProps = (0, _utils2.useSlotProps)({
    elementType: InputStartDecorator,
    externalSlotProps: componentsProps.startDecorator,
    ownerState,
    className: classes.startDecorator
  });
  const endDecoratorProps = (0, _utils2.useSlotProps)({
    elementType: InputEndDecorator,
    externalSlotProps: componentsProps.endDecorator,
    ownerState,
    className: classes.endDecorator
  });
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(InputRoot, (0, _extends2.default)({}, rootProps, {
    children: [startDecorator && /*#__PURE__*/(0, _jsxRuntime.jsx)(InputStartDecorator, (0, _extends2.default)({}, startDecoratorProps, {
      children: startDecorator
    })), /*#__PURE__*/(0, _jsxRuntime.jsx)(InputInput, (0, _extends2.default)({}, inputProps)), endDecorator && /*#__PURE__*/(0, _jsxRuntime.jsx)(InputEndDecorator, (0, _extends2.default)({}, endDecoratorProps, {
