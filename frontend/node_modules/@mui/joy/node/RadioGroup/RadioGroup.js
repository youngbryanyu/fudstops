...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', row && 'row', variant && `variant${(0, _utils.unstable_capitalize)(variant)}`, color && `color${(0, _utils.unstable_capitalize)(color)}`, size && `size${(0, _utils.unstable_capitalize)(size)}`]
  };
...
const RadioGroup = /*#__PURE__*/React.forwardRef(function RadioGroup(inProps, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_RadioGroupContext.default.Provider, {
    value: contextValue,
    children: /*#__PURE__*/(0, _jsxRuntime.jsx)(RadioGroupRoot, (0, _extends2.default)({
      ref: ref,
      role: role,
      as: component,
      ownerState: ownerState,
      className: (0, _clsx.default)(classes.root, className) // The `id` is just for the completeness, it does not have any effect because RadioGroup (div) is non-labellable element
