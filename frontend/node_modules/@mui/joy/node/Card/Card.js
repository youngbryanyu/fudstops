...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', variant && `variant${(0, _utils.unstable_capitalize)(variant)}`, color && `color${(0, _utils.unstable_capitalize)(color)}`, size && `size${(0, _utils.unstable_capitalize)(size)}`, row && 'row']
  };
...
const Card = /*#__PURE__*/React.forwardRef(function Card(inProps, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_CardContext.CardRowContext.Provider, {
    value: row,
    children: /*#__PURE__*/(0, _jsxRuntime.jsx)(CardRoot, (0, _extends2.default)({
      as: component,
