...
const useUtilityClasses = ownerState => {
  const slots = {
    ...
    ownerState.inset && ownerState.inset !== 'context' && `inset${(0, _utils.unstable_capitalize)(ownerState.inset)}`]
  };
  return (0, _composeClasses.default)(slots, _listDividerClasses.getListDividerUtilityClass, {});
};

const ListDividerRoot = (0, _styles.styled)(_Divider.default, {
  name: 'JoyListDivider',
  slot: 'Root',
...
const ListDivider = /*#__PURE__*/React.forwardRef(function ListDivider(inProps, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(ListDividerRoot // @ts-ignore
  , (0, _extends2.default)({
    ref: ref
  }, inset === 'context' && {
    inset
...
= {
   ...
   */
  inset: _propTypes.default
  /* @typescript-to-proptypes-ignore */
  .oneOfType([_propTypes.default.oneOf(['gutter', 'startDecorator', 'startContent']), _propTypes.default.string]),
