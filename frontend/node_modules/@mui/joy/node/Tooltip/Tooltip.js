...
const TooltipRoot = (0, _styled.default)('div', {
  ...
  return (0, _extends2.default)({}, ownerState.size === 'sm' && {
    ...
    '&::before': {
      ...
      display: 'block',
      position: 'absolute',
      width: (_ownerState$placement = ownerState.placement) != null && _ownerState$placement.match(/(top|bottom)/) ? '100%' : // 10px equals the default offset popper config
...
const Tooltip = /*#__PURE__*/React.forwardRef(function Tooltip(inProps, ref) {
  ...
  const {
    ...
    ref: focusVisibleRef
  } = (0, _utils.unstable_useIsFocusVisible)(); // We don't necessarily care about the focusVisible state (which is safe to access via ref anyway).
  ...
  const handleRef = (0, _utils.unstable_useForkRef)(children.ref, handleFocusRef); // There is no point in displaying an empty tooltip.
  ...
  const rootProps = (0, _utils2.useSlotProps)({
    ...
    ownerState,
    className: (0, _clsx.default)(classes.root, (_componentsProps$root = componentsProps.root) == null ? void 0 : _componentsProps$root.className)
  });
  const tooltipArrowProps = (0, _utils2.useSlotProps)({
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(React.Fragment, {
    children: [/*#__PURE__*/React.isValidElement(children) && /*#__PURE__*/React.cloneElement(children, childrenProps), /*#__PURE__*/(0, _jsxRuntime.jsxs)(_base.PopperUnstyled, (0, _extends2.default)({
      ...
      children: [title, arrow ? /*#__PURE__*/(0, _jsxRuntime.jsx)(TooltipArrow, (0, _extends2.default)({}, tooltipArrowProps, {
        className: (0, _clsx.default)(classes.arrow, (_componentsProps$arro2 = componentsProps.arrow) == null ? void 0 : _componentsProps$arro2.className),
        ref: setArrowRef,
        ownerState: ownerState
      })) : null]
    }))]
