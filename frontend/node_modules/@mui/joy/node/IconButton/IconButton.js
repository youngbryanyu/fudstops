...
exports.default = exports.IconButtonRoot = void 0;
...
const _excluded = ["children", "action", "component", "color", "variant", "size"];
...
const useUtilityClasses = ownerState => {
  ...
  const composedClasses = (0, _composeClasses.default)(slots, _iconButtonClasses.getIconButtonUtilityClass, {});
...
const IconButtonRoot = (0, _styles.styled)('button', {
  name: 'JoyIconButton',
  slot: 'Root',
  ...
  return [(0, _extends2.default)({
    ...
    [`&.${_iconButtonClasses.default.disabled}`]: (_theme$variants4 = theme.variants[`${ownerState.variant}Disabled`]) == null ? void 0 : _theme$variants4[ownerState.color]
  }];
});
...
const IconButton = /*#__PURE__*/React.forwardRef(function IconButton(inProps, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(IconButtonRoot, (0, _extends2.default)({}, rootProps, {
    children: children
  }));
});
