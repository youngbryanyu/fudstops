...
const _excluded = ["color", "backgroundColor"],
      _excluded2 = ["componentsProps", "component", "children", "className", "color", "size", "variant", "thickness", "determinate", "value"];
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', determinate && 'determinate', color && `color${(0, _utils2.unstable_capitalize)(color)}`, variant && `variant${(0, _utils2.unstable_capitalize)(variant)}`, size && `size${(0, _utils2.unstable_capitalize)(size)}`],
    svg: ['svg'],
    track: ['track'],
    progress: ['progress']
  };
...
const CircularProgress = /*#__PURE__*/React.forwardRef(function CircularProgress(inProps, ref) {
  ...
  const rootProps = (0, _utils.useSlotProps)((0, _extends2.default)({
  ...
  const svgProps = (0, _utils.useSlotProps)({
  ...
  const progressProps = (0, _utils.useSlotProps)({
    elementType: CircularProgressProgress,
    externalSlotProps: componentsProps.progress,
    ownerState,
    className: classes.progress
  });
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(CircularProgressRoot, (0, _extends2.default)({}, rootProps, {
    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(CircularProgressSvg, (0, _extends2.default)({}, svgProps, {
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(CircularProgressTrack, (0, _extends2.default)({}, trackProps)), /*#__PURE__*/(0, _jsxRuntime.jsx)(CircularProgressProgress, (0, _extends2.default)({}, progressProps))]
    })), children]
  }));
});
