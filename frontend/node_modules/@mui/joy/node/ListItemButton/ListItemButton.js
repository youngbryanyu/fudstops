...
exports.default = exports.ListItemButtonRoot = void 0;
...
const useUtilityClasses = ownerState => {
  ...
  const composedClasses = (0, _composeClasses.default)(slots, _listItemButtonClasses.getListItemButtonUtilityClass, {});
...
const ListItemButtonRoot = (0, _styles.styled)('div', {
  ...
  return [(0, _extends2.default)({}, ownerState.selected && {
    ...
    [`&.${_listItemButtonClasses.default.disabled}`]: (_theme$variants4 = theme.variants[`${ownerState.variant}Disabled`]) == null ? void 0 : _theme$variants4[ownerState.color]
  }];
});
exports.ListItemButtonRoot = ListItemButtonRoot;
