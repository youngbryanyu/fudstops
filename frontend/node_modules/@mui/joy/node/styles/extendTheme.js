...
function extendTheme(themeOptions) {
  ...
  const lightColorSystem = {
    palette: {
      ...
      info: (0, _extends2.default)({}, _colors.default.purple, createLightModeVariantVariables('info')),
  ...
  const darkColorSystem = {
    palette: {
      ...
      info: (0, _extends2.default)({}, _colors.default.purple, createDarkModeVariantVariables('info')),
  ...
  const theme = (0, _extends2.default)({
    ...
    variants: (0, _utils.deepmerge)({
      plain: (0, _variantUtils.createVariant)('plain', variantInput),
      plainHover: (0, _variantUtils.createVariant)('plainHover', variantInput),
      plainActive: (0, _variantUtils.createVariant)('plainActive', variantInput),
      plainDisabled: (0, _variantUtils.createVariant)('plainDisabled', variantInput),
      outlined: (0, _variantUtils.createVariant)('outlined', variantInput),
      outlinedHover: (0, _variantUtils.createVariant)('outlinedHover', variantInput),
      outlinedActive: (0, _variantUtils.createVariant)('outlinedActive', variantInput),
      outlinedDisabled: (0, _variantUtils.createVariant)('outlinedDisabled', variantInput),
      soft: (0, _variantUtils.createVariant)('soft', variantInput),
      softHover: (0, _variantUtils.createVariant)('softHover', variantInput),
      softActive: (0, _variantUtils.createVariant)('softActive', variantInput),
      softDisabled: (0, _variantUtils.createVariant)('softDisabled', variantInput),
      solid: (0, _variantUtils.createVariant)('solid', variantInput),
      solidHover: (0, _variantUtils.createVariant)('solidHover', variantInput),
      solidActive: (0, _variantUtils.createVariant)('solidActive', variantInput),
      solidDisabled: (0, _variantUtils.createVariant)('solidDisabled', variantInput)
    }, variantsInput),
    cssVarPrefix,
    getCssVar,
