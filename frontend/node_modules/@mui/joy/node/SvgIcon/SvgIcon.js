...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', color && `color${(0, _utils.unstable_capitalize)(color)}`, fontSize && `fontSize${(0, _utils.unstable_capitalize)(fontSize)}`]
  };
...
const SvgIconRoot = (0, _styled.default)('svg', {
  ...
  return (0, _extends2.default)({}, ownerState.instanceFontSize && ownerState.instanceFontSize !== 'inherit' && {
...
= {
  ...
  .oneOfType([_propTypes.default.oneOf(['danger', 'info', 'inherit', 'neutral', 'primary', 'success', 'warning']), _propTypes.default.string]),
   ...
   * @default 'xl'
   */
  fontSize: _propTypes.default.oneOf(['inherit', 'lg', 'md', 'sm', 'xl', 'xl2', 'xl3', 'xl4', 'xl5', 'xl6', 'xl7', 'xs', 'xs2', 'xs3']),
