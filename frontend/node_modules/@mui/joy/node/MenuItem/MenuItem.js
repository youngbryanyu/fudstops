...
const MenuItemRoot = (0, _styles.styled)(_ListItemButton.ListItemButtonRoot, {
  name: 'JoyMenuItem',
  slot: 'Root',
...
= {
  ...
  /* @typescript-to-proptypes-ignore */
  .oneOfType([_propTypes.default.oneOf(['contained', 'light', 'outlined', 'text']), _propTypes.default.string])
} : void 0;
