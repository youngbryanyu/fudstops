...
const useUtilityClasses = ownerState => {
  const slots = {
    root: ['root', ownerState.orientation === 'vertical' && 'vertical', ownerState.inset && `inset${(0, _utils.unstable_capitalize)(ownerState.inset)}`]
  };
  return (0, _composeClasses.default)(slots, _dividerClasses.getDividerUtilityClass, {});
};

const DividerRoot = (0, _styles.styled)('hr', {
  name: 'JoyDivider',
  slot: 'Root',
...
= {
  ...
  .oneOfType([_propTypes.default.oneOf(['none', 'context']), _propTypes.default.string]),
...
} : void 0; // @ts-ignore internal logic
