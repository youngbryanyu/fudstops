...
const useUtilityClasses = () => {
  ...
  return (0, _composeClasses.default)(slots, _listItemDecoratorClasses.getListItemDecoratorUtilityClass, {});
};
...
const ListItemDecorator = /*#__PURE__*/React.forwardRef(function ListItemDecorator(inProps, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(ListItemDecoratorRoot, (0, _extends2.default)({
    ref: ref,
    as: component,
...
process.env.NODE_ENV !== "production" ? ListItemDecorator.propTypes
/* remove-proptypes */
= {
  // ----------------------------- Warning --------------------------------
...
var _default = ListItemDecorator;
