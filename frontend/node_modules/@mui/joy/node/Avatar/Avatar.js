...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', variant && `variant${(0, _utils2.unstable_capitalize)(variant)}`, color && `color${(0, _utils2.unstable_capitalize)(color)}`, size && `size${(0, _utils2.unstable_capitalize)(size)}`],
    img: [(src || srcSet) && 'img'],
    fallback: ['fallback']
  };
...
const Avatar = /*#__PURE__*/React.forwardRef(function Avatar(inProps, ref) {
  ...
  const loaded = useLoaded((0, _extends2.default)({}, imgProps, typeof componentsProps.img === 'function' ? componentsProps.img(ownerState) : componentsProps.img, {
    src,
    srcSet
  }));
  ...
  const imageProps = (0, _utils.useSlotProps)({
  ...
  const fallbackProps = (0, _utils.useSlotProps)({
  ...
  if (hasImgNotFailing) {
    children = /*#__PURE__*/(0, _jsxRuntime.jsx)(AvatarImg, (0, _extends2.default)({}, imageProps));
  } else if (childrenProp != null) {
    children = childrenProp;
  } else if (hasImg && alt) {
    children = alt[0];
  } else {
    children = /*#__PURE__*/(0, _jsxRuntime.jsx)(AvatarFallback, (0, _extends2.default)({}, fallbackProps));
  }
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(AvatarRoot, (0, _extends2.default)({}, rootProps, {
    children: children
  }));
});
