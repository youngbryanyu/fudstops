...
const _excluded = ["component", "children", "componentsProps", "ratio", "minHeight", "maxHeight", "objectFit", "color", "variant"];
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root'],
    content: ['content', variant && `variant${(0, _utils2.unstable_capitalize)(variant)}`, color && `color${(0, _utils2.unstable_capitalize)(color)}`]
  };
...
const AspectRatio = /*#__PURE__*/React.forwardRef(function AspectRatio(inProps, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(AspectRatioRoot, (0, _extends2.default)({}, rootProps, {
    children: /*#__PURE__*/(0, _jsxRuntime.jsx)(AspectRatioContent, (0, _extends2.default)({}, contentProps, {
