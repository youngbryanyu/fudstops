...
const _excluded = ["aria-label", "aria-valuetext", "component", "componentsProps", "classes", "disableSwap", "disabled", "defaultValue", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "onMouseDown", "orientation", "scale", "step", "tabIndex", "track", "value", "valueLabelDisplay", "valueLabelFormat", "isRtl", "color", "size", "variant"];
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', disabled && 'disabled', dragging && 'dragging', marked && 'marked', orientation === 'vertical' && 'vertical', track === 'inverted' && 'trackInverted', track === false && 'trackFalse', color && `color${(0, _utils.unstable_capitalize)(color)}`, size && `size${(0, _utils.unstable_capitalize)(size)}`],
    rail: ['rail'],
    track: ['track'],
    mark: ['mark'],
...
const sliderColorVariables = ({
  ...
  return (0, _extends2.default)({}, styles.border && {
...
const Slider = /*#__PURE__*/React.forwardRef(function Slider(inProps, ref) {
  ...
  const railProps = (0, _utils2.useSlotProps)({
    elementType: SliderRail,
    externalSlotProps: componentsProps.rail,
    ownerState,
    className: classes.rail
  });
  const trackProps = (0, _utils2.useSlotProps)({
  ...
  const valueLabelProps = (0, _utils2.useSlotProps)({
    elementType: SliderValueLabel,
    externalSlotProps: componentsProps.valueLabel,
    ownerState,
    className: classes.valueLabel
  });
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(SliderRoot, (0, _extends2.default)({}, rootProps, {
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(SliderRail, (0, _extends2.default)({}, railProps)), /*#__PURE__*/(0, _jsxRuntime.jsx)(SliderTrack, (0, _extends2.default)({}, trackProps)), marks.filter(mark => mark.value >= min && mark.value <= max).map((mark, index) => {
      ...
      return /*#__PURE__*/(0, _jsxRuntime.jsxs)(React.Fragment, {
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(SliderMark, (0, _extends2.default)({
          "data-index": index
        }, markProps, {
        ...
        })), mark.label != null ? /*#__PURE__*/(0, _jsxRuntime.jsx)(SliderMarkLabel, (0, _extends2.default)({
          "aria-hidden": true,
          "data-index": index
        }, markLabelProps, {
      ...
      const style = axisProps[axis].offset(percent);
      return /*#__PURE__*/(0, _jsxRuntime.jsxs)(SliderThumb, (0, _extends2.default)({
        "data-index": index
      }, thumbProps, {
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(SliderInput, (0, _extends2.default)({
          "data-index": index,
          "aria-label": getAriaLabel ? getAriaLabel(index) : ariaLabel,
          "aria-valuenow": scale(value),
          "aria-valuetext": getAriaValueText ? getAriaValueText(scale(value), index) : ariaValuetext,
          value: values[index]
        }, inputProps)), valueLabelDisplay !== 'off' ? /*#__PURE__*/(0, _jsxRuntime.jsx)(SliderValueLabel, (0, _extends2.default)({}, valueLabelProps, {
