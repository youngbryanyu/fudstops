...
function getSliderUtilityClass(slot) {
  return (0, _className.generateUtilityClass)('JoySlider', slot);
}

const sliderClasses = (0, _className.generateUtilityClasses)('JoySlider', ['root', 'disabled', 'dragging', 'marked', 'vertical', 'trackInverted', 'trackFalse', 'rail', 'track', 'mark', 'markActive', 'markLabel', 'thumb', 'thumbStart', 'thumbEnd', 'valueLabel', 'valueLabelOpen', 'colorPrimary', 'colorNeutral', 'colorDanger', 'colorInfo', 'colorSuccess', 'colorWarning', 'disabled', 'sizeSm', 'sizeMd', 'sizeLg']);
