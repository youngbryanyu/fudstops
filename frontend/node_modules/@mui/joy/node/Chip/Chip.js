...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', disabled && 'disabled', color && `color${(0, _utils2.unstable_capitalize)(color)}`, size && `size${(0, _utils2.unstable_capitalize)(size)}`, variant && `variant${(0, _utils2.unstable_capitalize)(variant)}`, clickable && 'clickable'],
    action: ['action', disabled && 'disabled', focusVisible && 'focusVisible'],
    label: ['label', size && `label${(0, _utils2.unstable_capitalize)(size)}`],
    startDecorator: ['startDecorator'],
    endDecorator: ['endDecorator']
  };
  return (0, _base.unstable_composeClasses)(slots, _chipClasses.getChipUtilityClass, {});
};
...
const ChipRoot = (0, _styled.default)('div', {
  ...
  return [(0, _extends2.default)({
    ...
    [`&.${_chipClasses.default.disabled}`]: (_theme$variants2 = theme.variants[`${ownerState.variant}Disabled`]) == null ? void 0 : _theme$variants2[ownerState.color]
  }] : [{
...
const ChipAction = (0, _styled.default)('button', {
  ...
  return [{
    ...
    [`&.${_chipClasses.default.disabled}`]: (_theme$variants6 = theme.variants[`${ownerState.variant}Disabled`]) == null ? void 0 : _theme$variants6[ownerState.color]
  }];
});
...
const Chip = /*#__PURE__*/React.forwardRef(function Chip(inProps, ref) {
  ...
  const {
    focusVisible,
    getRootProps
  } = (0, _base.useButton)((0, _extends2.default)({}, resolvedActionProps, {
    disabled,
    ref: actionRef
  }));
  ...
  const id = (0, _utils2.unstable_useId)(labelProps.id);
  const actionProps = (0, _utils.useSlotProps)({
  ...
  const startDecoratorProps = (0, _utils.useSlotProps)({
    elementType: ChipStartDecorator,
    externalSlotProps: componentsProps.startDecorator,
    ownerState,
    className: classes.startDecorator
  });
  const endDecoratorProps = (0, _utils.useSlotProps)({
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_ChipContext.default.Provider, {
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(ChipRoot, (0, _extends2.default)({
      as: component,
      className: (0, _clsx.default)(classes.root, className),
      ref: ref,
      ownerState: ownerState
    }, other, {
      children: [clickable && /*#__PURE__*/(0, _jsxRuntime.jsx)(ChipAction, (0, _extends2.default)({}, actionProps)), /*#__PURE__*/(0, _jsxRuntime.jsx)(ChipLabel, (0, _extends2.default)({}, labelProps, {
        id: id,
        children: children
      })), startDecorator && /*#__PURE__*/(0, _jsxRuntime.jsx)(ChipStartDecorator, (0, _extends2.default)({}, startDecoratorProps, {
        children: startDecorator
      })), endDecorator && /*#__PURE__*/(0, _jsxRuntime.jsx)(ChipEndDecorator, (0, _extends2.default)({}, endDecoratorProps, {
...
= {
  ...
  /* @typescript-to-proptypes-ignore */
  .oneOfType([_propTypes.default.oneOf(['lg', 'md', 'sm']), _propTypes.default.string]),
