...
const useUtilityClasses = ownerState => {
  ...
  return (0, _composeClasses.default)(slots, _textareaClasses.getTextareaUtilityClass, {});
};
...
const TextareaRoot = (0, _styles.styled)('div', {
  ...
  return [(0, _extends2.default)({
    ...
    [`&:hover:not(.${_textareaClasses.default.focused})`]: (0, _extends2.default)({}, (_theme$variants2 = theme.variants[`${ownerState.variant}Hover`]) == null ? void 0 : _theme$variants2[ownerState.color], {
    ...
    [`&.${_textareaClasses.default.focused}`]: {
      '&:before': {
...
const TextareaInput = (0, _styles.styled)(_TextareaAutosize.default, {
  name: 'JoyTextarea',
  slot: 'Textarea',
...
const Textarea = /*#__PURE__*/React.forwardRef(function Textarea(inProps, ref) {
  ...
  const textareaProps = (0, _utils2.useSlotProps)({
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(TextareaRoot, (0, _extends2.default)({}, rootProps, {
    children: [startDecorator && /*#__PURE__*/(0, _jsxRuntime.jsx)(TextareaStartDecorator, {
      className: classes.startDecorator,
      ownerState: ownerState,
      children: startDecorator
    }), /*#__PURE__*/(0, _jsxRuntime.jsx)(TextareaInput, (0, _extends2.default)({}, textareaProps)), endDecorator && /*#__PURE__*/(0, _jsxRuntime.jsx)(TextareaEndDecorator, {
...
= {
  ...
  componentsProps: _propTypes.default.shape({
    ...
    textarea: _propTypes.default.oneOfType([_propTypes.default.func, _propTypes.default.object])
  }),
