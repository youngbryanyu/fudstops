...
var _CardContext = require("../Card/CardContext");
...
const CardOverflowRoot = (0, _styled.default)('div', {
  ...
  return [ownerState.row ? (0, _extends2.default)({
...
const CardOverflow = /*#__PURE__*/React.forwardRef(function CardOverflow(inProps, ref) {
  ...
  const row = React.useContext(_CardContext.CardRowContext);
  const {
    className,
    component = 'div',
    children,
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(CardOverflowRoot, (0, _extends2.default)({
    as: component,
...
process.env.NODE_ENV !== "production" ? CardOverflow.propTypes
/* remove-proptypes */
= {
  // ----------------------------- Warning --------------------------------
