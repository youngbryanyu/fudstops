...
const _excluded = ["children", "className", "component", "componentsProps", "size", "separator"];
...
const Breadcrumbs = /*#__PURE__*/React.forwardRef(function Breadcrumbs(inProps, ref) {
  ...
  }).map((child, index) => /*#__PURE__*/(0, _jsxRuntime.jsx)(BreadcrumbsLi, (0, _extends2.default)({}, liProps, {
    children: child
  }), `child-${index}`));
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(BreadcrumbsRoot, (0, _extends2.default)({}, rootProps, {
    children: /*#__PURE__*/(0, _jsxRuntime.jsx)(BreadcrumbsOl, (0, _extends2.default)({}, olProps, {
      children: allItems.reduce((acc, current, index) => {
        if (index < allItems.length - 1) {
          acc = acc.concat(current, /*#__PURE__*/(0, _jsxRuntime.jsx)(BreadcrumbsSeparator, (0, _extends2.default)({}, separatorProps, {
            children: separator
          }), `separator-${index}`));
        } else {
          acc.push(current);
