...
const MenuRoot = (0, _styles.styled)(_List.ListRoot, {
  name: 'JoyMenu',
  slot: 'Root',
...
const Menu = /*#__PURE__*/React.forwardRef(function Menu(inProps, ref) {
  ...
  const {
    ...
    size = 'md'
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, _excluded); // cache the modifiers to prevent Popper from being recreated when React rerenders menu.
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_PopperUnstyled.default, (0, _extends2.default)({}, rootProps, {
