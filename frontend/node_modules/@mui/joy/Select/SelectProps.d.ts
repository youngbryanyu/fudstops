...
export declare type SelectSlot = 'root' | 'button' | 'startDecorator' | 'endDecorator' | 'indicator' | 'listbox';
...
interface ComponentsProps {
    ...
    button?: SlotComponentProps<'button', {
        sx?: SxProps;
    }, SelectOwnerState<any>>;
    ...
    indicator?: SlotComponentProps<'span', {
        sx?: SxProps;
    }, SelectOwnerState<any>>;
    listbox?: SlotComponentProps<'ul', Omit<PopperUnstyledOwnProps, 'components' | 'componentsProps' | 'open'> & {
...
export declare type SelectProps<TValue extends {}, D extends React.ElementType = SelectTypeMap<TValue>['defaultComponent']> = OverrideProps<SelectTypeMap<TValue, {}, D>, D> & {
    component?: D;
};
